...
function Home() {
    ...
    return ( <
            ...
            <
            img className = { classnames(styles.heroBannerLogo, 'margin-vert--md') }
            ...
            <
            iframe src = "https://ghbtns.com/github-btn.html?user=antonio1980&amp;repo=InterviewSite&amp;type=star&amp;count=true&amp;size=large"
            frameBorder = { 0 }
            scrolling = { 0 }
            width = { 160 }
            height = { 30 }
            ...
            href = "https://www.moonchaser.io/?utm_source=interviewsite&utm_medium=referral&utm_content=website_homepage"
            ...
            successStories.map((user) => ( <
                ...
                small className = "avatar__subtitle" > { user.title } <
                /small> < /
                div > <
                /div> < /
                div > <
        ...
        a href = "https://github.com/antonio1980/interviewsite/edit/master/website/src/data/successStories.js"
    target = "_blank" >
